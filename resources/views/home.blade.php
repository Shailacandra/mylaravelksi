            ...
            <h6 class="mt-3">
                ...
                atau <a href="{{ route('auth.register') }}" style="text-decoration: none">daftar</a>
                 jika anda belum punya akun
                  ...
                  <a style="text-decoration: none;" href="{{route('inf.beritaKSI')}}">Berita KSI</a> |
                    <a style="text-decoration: none;" href="{{route('inf.profilekelulusanKSI')}}">Profile Kelulusan</a> |
                    <a style="text-decoration: none;" href="{{route('inf.profileDosen')}}">Profile Dosen </a>
          </div>
        </div>     
      </div>
